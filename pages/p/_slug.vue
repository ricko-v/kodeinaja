          ...
          <div class="col-lg-8 mb-5 p-0">
            <div class="card shadow-sm p-3">
              ...
              <small class="text-secondary">
                <Tanggal :tanggal="posts[0].createdAt"></Tanggal> |
                <NuxtLink
                  :to="'/user/' + posts[0].username"
                  class="text-secondary"
                  >{{ posts[0].username }}</NuxtLink
                >
              </small>
              <div class="d-flex overflow-auto mt-1">
                <NuxtLink
                  v-for="tag in posts[0].tag"
                  :key="tag"
                  :to="'/tag/' + tag"
                  :class="'bg-' + gachaWarna()"
                  class="px-2 mt-2 mr-2 pb-1 text-white rounded"
                >
              ...
              <div class="container giscus my-4">
                <script
                  ...
                  data-repo="ricko-v/kodeinaja"
                  data-repo-id="R_kgDOHLpX4g"
                  data-category="General"
                  data-category-id="DIC_kwDOHLpX4s4CPI_1"
